...
class HyperparameterTuner(object):
    ...
    def deploy(
        ...
        **kwargs
        ...
        best_estimator = self.estimator.attach(
            self.best_training_job(), sagemaker_session=self.estimator.sagemaker_session
        )
    ...
    def _prepare_init_params_from_job_description(cls, job_details):
        ...
        return {
            ...
            "objective_metric_name": tuning_config["HyperParameterTuningJobObjective"][
                "MetricName"
            ],
            "objective_type": tuning_config["HyperParameterTuningJobObjective"]["Type"],
            "hyperparameter_ranges": cls._prepare_parameter_ranges(
